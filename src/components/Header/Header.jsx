...
export const Header = () => {
  ...
  return (
    <header className="border-b bg-#1a98ecbd z-10  border-gray-300 py-2 sticky top-0">
      <div className="flex items-center  bg-#1a98ecbd justify-between lg:mr-4 mx-0 mx-auto flex-wrap relative">
        <FiMenu
        ...
        <nav
          className={`${
            open ? "block" : "hidden"
          } w-50% lg:flex lg:items-center lg:w-auto absolute top-[100%] mt-2 h-screen bg-slate-600 bg-opacity-60 pb-5`}
        >
          <ul
            className={`${
              open ? "hidden" : "hidden"
