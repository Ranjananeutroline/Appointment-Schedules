      ...
      <table className="w-full h-full">
        <thead className="bg-[#E2F2FA]">
          <tr className="h-[50px] text-[12px] md:text-[16px]">
            <th className="font-man  font-medium  w-[5%] md:w-[4%]">ID</th>
            <th className="font-man  font-medium  w-[25%] md:w-[20%]">Name</th>
            <th className="font-man  font-medium w-[20%] md:w-[15%]">Services</th>
            <th className="font-man  font-medium w-[15%] md:w-[11%]">Time</th>
            <th className="font-man  font-medium w-[15%] md:w-[11%]">Duration</th>
            <th className="font-man  font-medium w-[10%] md:w-[11%]">Status</th>
            <th className="font-man  font-medium w-[10%] md:w-[13%]">Action</th>
            <th className="font-man  font-medium w-[10%] md:w-[10%]">Reminder</th>
          </tr>
        </thead>
        <tbody>
          {data.map((item) => (
            ...
            >
              ...
              <td className="text-left w-[25%] md:w-[20%] py-3.5 md:p-5 today-item-name">
                <button
                  // className="border "
              ...
              <td className="text-left w-[20%] md:w-[15%] py-3 md:p-5 today-item-ser">
                {item.services}
              </td>
