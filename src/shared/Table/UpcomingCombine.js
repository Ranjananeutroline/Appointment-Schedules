...
// function UpcomingCombine() {
//   return (
//     <div>
//       <Completed />
//       <div className=" my-[10px] md:my-[12px] w-full text-right">
//         <Date />
//       </div>
//       <Completed />
//     </div>
...
// export default UpcomingCombine;
...
import "./css/UpcomingCompleted.css";
        ...
        <table className="w-[800px] md:w-full h-full">
          <thead className="bg-[#E2F2FA]">
            <tr className="h-[50px] text-[16px] md:text-[100%]">
              ...
              <th className="font-medium w-[12%]">Date</th>
              <th className="font-medium w-[12%]">Status</th>
              <th className="font-medium w-[10%]">Action</th>
              <th className="font-medium w-[12%]">Reminder</th>
            </tr>
          </thead>
          <tbody>
            {data.map((item) => (
              ...
              >
                <td className="text-center w-[5%] md:w-[3%]">
                  {item.id}
                </td>
              ...
              <div className="  bg-[#f8f8f8]   p-2 flex flex-col border  rounded-[0.3rem]  justify-between gap-3">
                ...
                >
                  <button
                    ...
                    onClick={() => toggleExpand(item.id)}
                    className="absolute cursor-none  bottom-3 right-2 bg-[#53b2f1] hover:bg-[#69bdf5] p-2 rounded-full "
                  >
                    <motion.div
                ...
                {expandedItem === item.id && (
                  <motion.div
                    className=" flex gap-1  absolute right-[2%] top-[50%]  "
                  ...
                  >
                    ...
                    >
                      <button
                        onClick={() => handleCommit(item.id)}
                        className="group border-none  cursor-none  focus:scale-110   bg-white rounded-2xl p-2 "
                      >
                        {item.status === "Pending" ? (
                          <>
                            <div className=" ">
                    ...
                    >
                      <button
                        ...
                        className="group cursor-none  focus:scale-110   bg-white p-1.5  rounded-xl relative"
                      >
                        <img
                          className="md:hidden w-[13px] h-[15px]"
                          src={Reschedule}
                    ...
                    >
                      <button
                        onClick={onOpenModal}
                        className="group cursor-none focus:scale-110  border-none   bg-white p-1.5 rounded-2xl "
                      >
                        <div className=" ">
                          <svg
                            width="14"
                    ...
                    >
                      {!item.notified ? (
                        <button
                          className="flex  cursor-none  border-none  focus:scale-110  rounded-2xl p-1.5  bg-[#ffffff] md:px-3 md:gap-1 text-[15px] justify-center items-center md:p-1"
                          onClick={() => handleNotifyClick(item.id)}
                        >
                          <img className="w-4 " src={bell} alt="notification" />
                        </button>
                        ...
                        <button
                          ...
                          className="flex  group cursor-none border-none focus:scale-110  right-[0.4rem]  bg-white rounded-2xl gap-1 p-1.5 text-[14px] justify-center items-center md:p-1"
                        >
                          <img className="w-4" src={vector} alt="notified" />
                          {showNotified && (
                            <p className=" text-[10px] md:hidden md:group-hover:block absolute bottom-8 right-1 p-1 rounded  bg-white shadow">
                              Notified
                            </p>
                          )}
                        </button>
