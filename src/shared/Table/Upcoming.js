...
import TommorowDate from "../../shared/Date/TommorowDate";
...
function Upcoming({ childAddAppointment, searchText, searchTermFromUpcoming }) {
  ...
  return (
    <>
      <div className=" w-[100%]  overflow-y-auto h-[182px] hidden md:flex items-center flex-col first-scroll-box">
          ...
          <tbody>
            {filteredData.map((item) => (
              ...
              >
                ...
                <td className=" flex flex-col md:flex-row justify-center items-center p-2 gap-1  md:gap-2 md:p-4 md:h-[60px] ">
                  <button
      ...
      <div className=" w-[100%]  overflow-y-auto h-[300px]   md:hidden items-center flex-col">
        <table className="w-full ">
          <thead className="border ">
            <tr className=" h-[50px] text-[13px]   md:text-[15px] bg-[#E2F2FA] ">
              <th className="font-man  font-medium w-[25%] md:w-[20%]">Name</th>
          ...
          <tbody>
            {filteredData.map((item) => (
              ...
              >
                ...
                <td className="text-center overflow-hidden break-words text-[13px]   py-3   md:text-[16px] md:p-5">
                  {item.services}
                </td>
                <td className=" md:text-center   p-2   md:text-[16px] md:p-3 text-[#0038FF] ">
                  {item.time}
                ...
                <td className=" flex flex-col md:flex-row justify-center items-center p-2 gap-1  md:p-4 md:h-[60px] ">
                  <button
                    onClick={() => handleCommit(item.id)}
                    className="group relative"
                  >
      ...
      <div className=" w-[100%]  overflow-y-auto  md:hidden items-center flex-col">
        <table className="w-full ">
          <thead
            className="
           "
          >
            <tr className="  invisible text-[13px]   md:text-[15px] bg-[#E2F2FA] ">
              <th className="font-man  font-medium w-[25%] md:w-[20%]">Name</th>
              <th className="font-man  font-medium w-[25%] md:w-[20%] ">
                Services
              </th>
      ...
      <div className=" w-[100%]  overflow-y-auto h-[220px]  hidden md:flex items-center flex-col second-scroll-box">
        <table className="w-full ">
          <thead className=" ">
            <tr className="invisible text-[13px]   md:text-[15px] bg-[#E2F2FA] ">
              <th className="font-man  first-letter: font-medium px-4 w-[5%] md:w-[3%] ">
